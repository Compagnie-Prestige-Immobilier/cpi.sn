...
export async function generateMetadata({ params }: Props) {
  ...
  return {
    ...
    alternates: alternatesForSlugs(locale as Locale, '/terrains/[slug]', { [locale as Locale]: slug }),
...
export default async function PropertyPage({ params }: Props) {
  ...
  const url = absoluteUrl(
    getPathname({ locale: locale as Locale, href: { pathname: '/terrains/[slug]', params: { slug } } }),
  )
  ...
  const data = graph(
    ...
    breadcrumbJsonLd([
      ...
      {
        name: tNav('land'),
        url: absoluteUrl(getPathname({ locale: locale as Locale, href: '/terrains' })),
      },
